...
For the gated, stateless Responses endpoint, see the [Responses API guide](/llm-router/responses)
and its [model-specific capability matrix](/llm-router/responses-capabilities).
The Chat Completions examples above do not establish Responses model availability.
...
<CardGroup cols={2}>
  ...
  <Card title="Audio API" icon="waveform" href="/llm-router/audio">
    Use OpenAI-compatible file transcription and streamed speech.
  </Card>
</CardGroup>
