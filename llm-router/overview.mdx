...
For structured TypeSafe Jev evaluation, see the separately gated
[Decisions API](/llm-router/decisions). It uses native questions and answers
instead of the chat-completions contract.
