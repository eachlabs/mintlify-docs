...
<Note>
**Contract stability.** Request shapes documented here are stable: additions may land, removals will not without notice — see [Versioning](/video/versioning).
</Note>
