...
**Inputs:** `input_urls` (2) — `input_urls[0]` is the music/program bed, `input_urls[1]` is the voice · **Tiers:** `cpu` only (a `gpu` request is rejected at $0) · **Output:** media — single audio file (mp3/wav/m4a)
...
**Inputs:** `input_urls` (2) — joined in order, first into second · **Tiers:** `cpu` only (a `gpu` request is rejected at $0) · **Output:** media — single file
...
**Inputs:** `input_urls` (2) — `input_urls[0]` is the base video, `input_urls[1]` is the sticker (image or video) · **Tiers:** `cpu` only (a `gpu` request is rejected at $0) · **Output:** media — single file
...
| `style.font` | string | `Liberation Sans` \| `Liberation Serif` \| `Liberation Mono` \| `DejaVu Sans` \| `DejaVu Serif` \| `DejaVu Sans Mono` \| `Anton` \| `Archivo Black` \| `Bangers` \| `Inter` \| `Montserrat` \| `Montserrat Black` \| `Poppins` | `"Liberation Sans"` | no |  |
| `style.font_size_pct` | integer | min 3, max 15 | `5` | no |  |
| `style.hook_font` | string | `Liberation Sans` \| `Liberation Serif` \| `Liberation Mono` \| `DejaVu Sans` \| `DejaVu Serif` \| `DejaVu Sans Mono` \| `Anton` \| `Archivo Black` \| `Bangers` \| `Inter` \| `Montserrat` \| `Montserrat Black` \| `Poppins` | `"Liberation Sans"` | no |  |
...
**Inputs:** `input_url` (1) · **Tiers:** `cpu` · `gpu` · **Output:** media — URL array in `output`, one entry per frame, index-ordered (`thumb_001`, `thumb_002`, …) — see [Response shapes](#response-shapes)
...
**Inputs:** `input_url` (1) · **Tiers:** `cpu` only (a `gpu` request is rejected at $0) · **Output:** media — single file
...
| `font` | string | `Liberation Sans` \| `Liberation Serif` \| `Liberation Mono` \| `DejaVu Sans` \| `DejaVu Serif` \| `DejaVu Sans Mono` \| `Anton` \| `Archivo Black` \| `Bangers` \| `Inter` \| `Montserrat` \| `Montserrat Black` \| `Poppins` | `"Liberation Sans"` | no | families bundled in the runtime image, rendered from the family's baked font file — never a fontconfig fallback |
