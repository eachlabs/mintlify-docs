...
| `font` | string | `Liberation Sans` \| `Liberation Serif` \| `Liberation Mono` \| `DejaVu Sans` \| `DejaVu Serif` \| `DejaVu Sans Mono` | `"Liberation Sans"` | no | families bundled in the runtime image, rendered from the family's baked font file — never a fontconfig fallback |
