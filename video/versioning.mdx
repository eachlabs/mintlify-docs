...
description: "What counts as a breaking change to the Video API, how much notice you get, and which parts of the contract are stable."
---
...
Two things evolve — the **rate card and the capability set** — never the request contract.
...
We do not remove a documented capability without the full 90-day window. The surface grows and the price may move; the ground does not shift under a request you already ship.
