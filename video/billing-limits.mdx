...
<Note>
**Beta.** The Video API is in private beta: these pages are shared by direct link and are not listed in the public navigation. Rates below are the current beta rate card and may be adjusted during the beta [with notice](/video/versioning); the *mechanics* (integer seconds, no multipliers, $0 rejects) are the contract.
</Note>
