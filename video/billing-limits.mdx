...
<Note>
**Beta.** Rates below are the current beta rate card and may be adjusted during the beta with notice; the *mechanics* (integer seconds, no multipliers, $0 rejects) are the contract.
</Note>
