...
<Note>
  One exception: public workflow triggers take your key as `api_key` in the JSON request body instead of a Bearer header — see [Public Workflows](/workflows/endpoints/public-workflows).
</Note>
