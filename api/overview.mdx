...
| `POST` | `/api/v1/uploads` | [Initiate a file upload](/api/uploads/overview) (storage service) |
| `GET` | `/api/v1/uploads/{id}` | [Check upload status](/api/uploads/get-upload-status) (storage service) |
