...
The model catalog (`GET /v1/models`, `GET /v1/model`, `GET /v1/llm-router/model-catalog`) is public; all other endpoints require an API key via the `Authorization: Bearer` header.
