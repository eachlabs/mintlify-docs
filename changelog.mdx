...
<Update label="July 14, 2026" description="Video API" rss={{ title: "New TikTok and Public Sans fonts for captions and title cards", description: "Video API" }}>
  ## New TikTok and Public Sans fonts for captions and title cards

  - The Video API now supports TikTok Sans, TikTok Display, TikTok Text, and
    Public Sans for caption and title-card rendering.
  - Regular and Medium variants are available for each family, giving video
    outputs more native-looking social caption styles.
</Update>
