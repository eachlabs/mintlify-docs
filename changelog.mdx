...
<Update label="July 10, 2026" description="Short Drama" rss={{ title: "Edit and regenerate individual storyboard beats", description: "Short Drama" }}>
  ## Edit only the storyboard beats you want

  - You can edit shot and segment prompts, then regenerate one beat without
    rerendering the rest of the storyboard.
  - Uploaded character references can be locked across regenerations, and
    animated or stylized projects now preserve their chosen visual direction.
  - When you update a finished shot, Short Drama automatically rebuilds the
    episode with the new result.
</Update>
