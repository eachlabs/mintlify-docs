...
<Update label="September 10, 2026" description="LLM Router" rss={{ title: "Find and run more LLM Router models", description: "LLM Router" }}>
  ## Find and run more LLM Router models

  - `deepseek/deepseek-v4.1-flash` is now available in the LLM Router model catalog, so you can call it through the router alongside the other curated models.
  - Large model pickers now become searchable, so you can type to find the model you need instead of scrolling through the full list.
</Update>
