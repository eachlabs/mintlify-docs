...
<Update label="September 15, 2026" description="LLM Router" rss={{ title: "Upload videos in LLM Router forms", description: "LLM Router" }}>
  ## Upload videos in LLM Router forms

  - LLM Router dashboard forms now show video inputs for models that support video, so you can submit video prompts through the same model-aware controls used for text and image requests.
</Update>

<Update label="September 14, 2026" description="Canvas Workflows" rss={{ title: "Workflow validation errors explain what to fix", description: "Canvas Workflows" }}>
  ## Workflow validation errors explain what to fix

  - Canvas autosave and workflow updates now surface the validation detail returned by the workflow, so issues like an invalid connection tell you what needs attention instead of only saying `invalid argument`.
  - Validation messages omit internal prefixes, so the error text is clearer and easier to act on from the canvas.
</Update>

<Update label="September 14, 2026" description="AI Models" rss={{ title: "Use real-person images with Seedance video models", description: "AI Models" }}>
  ## Use real-person images with Seedance video models

  - Seedance 2.0 and 2.5 image-to-video and reference-to-video workflows now prepare uploaded human-face images for the provider automatically, so real-person inputs can be used without a separate asset setup step.
</Update>

<Update label="September 14, 2026" description="AI Models" rss={{ title: "Stream every result from multi-song Mureka generations", description: "AI Models" }}>
  ## Stream every result from multi-song Mureka generations

  - Mureka generations that return multiple songs now publish each stream URL as it becomes available, so you can start listening to early results while the rest of the batch finishes.
</Update>

<Update label="September 14, 2026" description="API" rss={{ title: "Model details now use a path-based endpoint", description: "API" }}>
...
<Update label="September 9, 2026" description="Organization Settings" rss={{ title: "Control execution and storage retention for your organization", description: "Organization Settings" }}>
...
<Update label="September 9, 2026" description="LLM Router" rss={{ title: "An easier LLM Router interface and errors by model", description: "LLM Router" }}>
  ...
  - [Error Analytics](https://www.eachlabs.ai/error-analytics) now breaks down LLM Router errors by the requested model, so you can see which models are failing and focus your investigation.
</Update>
