...
<CardGroup cols={2}>
  <Card title="Flux 2 Edit" href="/models/image-generation/flux-2-edit">
    Dedicated image editing with mask-based inpainting.
  </Card>
...
<Note>
  Use `GET /v1/model?slug=flux-kontext-pro` to retrieve the full model schema, including all available parameters and their constraints.
</Note>
