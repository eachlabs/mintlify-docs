...
<CardGroup cols={2}>
  <Card title="Flux 2 Max" href="/models/image-generation/flux-2-max">
    Highest quality image generation for complex prompts.
  </Card>
  <Card title="SeedReam v4.5" href="/models/image-generation/seedream-v4-5">
    Creative and artistic image compositions.
  </Card>
</CardGroup>

<Note>
  Use `GET /v1/model?slug=gemini-imagen-4` to retrieve the full model schema, including all available parameters and their constraints.
</Note>
