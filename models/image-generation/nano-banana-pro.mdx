...
<CardGroup cols={2}>
  <Card title="Flux 2 Pro" href="/models/image-generation/flux-2-pro">
    General purpose image generation with balanced speed and quality.
  </Card>
  <Card title="Kling Text-to-Image" href="/models/image-generation/kling-text-to-image">
    Versatile image generation with negative prompt support.
  </Card>
</CardGroup>

<Note>
  Use `GET /v1/model?slug=nano-banana-pro` to retrieve the full model schema, including all available parameters and their constraints.
</Note>
