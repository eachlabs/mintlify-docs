...
- The prompt guides the motion applied to the source image rather than generating from scratch.
- Best results come from high-quality, well-composed source images.

## Related Models

<CardGroup cols={2}>
  <Card title="Wan v2.6 Image-to-Video" href="/models/video-generation/wan-v2-6-image-to-video">
    Open-source image animation with motion control.
  </Card>
...
<Note>
Use `GET /v1/model?slug=kling-2-1-image-to-video` to retrieve the full model schema including all available parameters and their constraints.
</Note>
