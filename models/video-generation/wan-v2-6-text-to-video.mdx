...
<CardGroup cols={2}>
  <Card title="Wan v2.6 Image-to-Video" href="/models/video-generation/wan-v2-6-image-to-video">
    Image animation variant of the same Wan model family.
  </Card>
...
<Note>
Use `GET /v1/model?slug=wan-v2-6-text-to-video` to retrieve the full model schema including all available parameters and their constraints.
</Note>
