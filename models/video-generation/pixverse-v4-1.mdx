...
<CardGroup cols={2}>
  <Card title="Wan v2.6 Text-to-Video" href="/models/video-generation/wan-v2-6-text-to-video">
    Open-source text-to-video with solid quality.
  </Card>
  <Card title="Veo 3.1 Fast" href="/models/video-generation/veo3-1-fast">
    Speed-optimized variant of Google's Veo.
  </Card>
</CardGroup>

<Note>
Use `GET /v1/model?slug=pixverse-v4-1` to retrieve the full model schema including all available parameters and their constraints.
</Note>
