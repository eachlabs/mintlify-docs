...
- Best suited for sound effects, ambient audio, and short clips (max ~45 seconds)
- For full songs or longer audio, use `mureka-generate-music` instead
- Descriptive prompts with specific details produce better results
- Works well for foley, UI sounds, game audio, and ambient backgrounds

## Related Models

<CardGroup cols={2}>
  <Card title="Mureka Music" href="/models/audio-music/mureka-generate-music">
    Full song generation for longer music tracks.
  </Card>
...
<Note>
Call `GET /v1/model?slug=stable-audio-2-5` for the full parameter schema.
</Note>
