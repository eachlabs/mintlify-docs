...
- Be descriptive about genre, mood, tempo, and instruments for best results
- Provide `lyrics` for vocal tracks, omit for instrumentals
- Max duration is approximately 3 minutes
- Include style keywords like "lo-fi", "orchestral", "hip-hop beat" for targeted output
- Processing may take longer for extended durations
...
<CardGroup cols={2}>
  ...
  <Card title="Stable Audio 2.5" href="/models/audio-music/stable-audio-2-5">
    Sound effects and short audio clips.
  </Card>
</CardGroup>

<Note>
Call `GET /v1/model?slug=mureka-generate-music` for the full parameter schema.
</Note>
