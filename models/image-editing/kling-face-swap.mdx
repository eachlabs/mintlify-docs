...
- Works best with clear, front-facing photos for both target and source images
- Both images should have visible, unobstructed faces
- Handles lighting and angle adjustments automatically for natural-looking results
- Use high-resolution images for the best output quality
- The source face will adapt to the target image's pose and expression
...
<CardGroup cols={2}>
  ...
  <Card title="Flux Kontext Pro" href="/models/image-generation/flux-kontext-pro">
    Contextual image editing with text rendering.
  </Card>
</CardGroup>

<Note>
Call `GET /v1/model?slug=kling-face-swap` for the full parameter schema.
</Note>
