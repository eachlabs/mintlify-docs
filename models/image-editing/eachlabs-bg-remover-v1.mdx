...
- Very fast processing, ideal for batch workflows
- Works well with people, products, and objects
- For best results, use images with clear foreground subjects
- Combine with other models: remove background first, then upscale or composite
...
<Note>
Call `GET /v1/model?slug=eachlabs-bg-remover-v1` for the full parameter schema.
</Note>
