...
<Note>
Video generation is async. Processing can take 30 seconds to several minutes depending on model and duration. Use [webhooks](/api/webhooks/overview) for production workflows. Pricing varies — check the [dashboard](https://eachlabs.ai).
</Note>

## Choosing the Right Model

- **Highest quality, cinematic output** — Use `veo-3` or `sora-2-pro`
- **Fast turnaround needed** — Use `veo3-1-fast` or `pixverse-v4-1`
...
<CardGroup cols={2}>
  <Card title="Veo 3" href="/models/video-generation/veo-3">
    Google's top video model. Cinematic quality with audio generation.
  </Card>
  <Card title="Veo 3.1 Fast" href="/models/video-generation/veo3-1-fast">
    Speed-optimized variant of Veo for quick generation.
  </Card>
  <Card title="Kling 3.0" href="/models/video-generation/kling-3-0">
    High-quality text-to-video with strong motion coherence.
  </Card>
  <Card title="Kling 2.1 Image-to-Video" href="/models/video-generation/kling-2-1-image-to-video">
    Animate any image into a dynamic video clip.
  </Card>
  <Card title="Wan v2.6 Image-to-Video" href="/models/video-generation/wan-v2-6-image-to-video">
    Image animation with motion control.
  </Card>
  <Card title="Wan v2.6 Text-to-Video" href="/models/video-generation/wan-v2-6-text-to-video">
    Open-source text-to-video generation.
  </Card>
  <Card title="PixVerse v4.1" href="/models/video-generation/pixverse-v4-1">
    Fast, stylized video generation.
  </Card>
  <Card title="Sora 2 Pro" href="/models/video-generation/sora-2-pro">
    OpenAI's cinematic video generation model.
  </Card>
</CardGroup>
