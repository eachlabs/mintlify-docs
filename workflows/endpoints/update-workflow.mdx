...
<Note>
  This endpoint is served at `https://workflows.eachlabs.run` and is fully supported.
</Note>

<Note>
  This updates workflow metadata only. To update the definition (steps), use [Create Version](/workflows/endpoints/create-version).
</Note>
