...
description: "HTTP status codes and error responses across all each::labs APIs."
---

## Error Response Format

All each::labs APIs return errors in a consistent JSON format:
...
We recommend exponential backoff for transient errors (429, 500):
