...
| each::workflows | `https://workflows.eachlabs.run/api/v1` | REST | Deprecated compatibility host; moving under `https://api.eachlabs.ai` |
| each::sense | `https://eachsense-agent.core.eachlabs.run` | REST + SSE | Deprecated compatibility host; moving under `https://api.eachlabs.ai` |
